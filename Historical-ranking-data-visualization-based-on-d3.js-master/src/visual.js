...
function draw(data) {
  ...
  // var colorIndex = Math.floor(Math.random() * Math.floor(17))
  var colorIndex = 1
  ...
  function getColor(d) {
    ...
    if (colorMap[d.name] !== undefined) {
      ...
      colorMap[d.name] = colorIndex
      return colorByIndex(colorIndex)
    }
    if (changeable_color) {
